...
CSV_FILE_PATH_RAW = "/home/ubuntu/airflow/outputs/concatenated_data.csv"
CSV_FILE_PATH_PREPROCESSED = "/home/ubuntu/airflow/outputs/data_Indeed_preprocessed.csv"
CSV_FILE_PATH_LIGHT_FILTERED = "/home/ubuntu/airflow/outputs/light_filtered_data.csv"
CSV_FILE_PATH_HEAVY_FILTERED = "/home/ubuntu/airflow/outputs/heavy_filtered_data.csv"
...
def load_raw_csv_to_postgres():
    ...
    with open(CSV_FILE_PATH_RAW, "r") as f:
...
def load_preprocessed_csv_to_postgres():
    # Get PostgreSQL connection
    pg_hook = PostgresHook(postgres_conn_id=POSTGRES_CONN_ID)
    conn = pg_hook.get_conn()
    cursor = conn.cursor()
    ...
    with open(CSV_FILE_PATH_PREPROCESSED, "r") as f:
        cursor.copy_expert("COPY preprocessed_temp FROM STDIN WITH CSV HEADER", f)
    ...
    drop_sql = "DROP TABLE IF EXISTS preprocessed_temp;"
    cursor.execute(drop_sql)
...
def load_light_filtered_csv_to_postgres():
    # Get PostgreSQL connection
    pg_hook = PostgresHook(postgres_conn_id=POSTGRES_CONN_ID)
    conn = pg_hook.get_conn()
    cursor = conn.cursor()
    ...
    with open(CSV_FILE_PATH_LIGHT_FILTERED, "r") as f:
        cursor.copy_expert("COPY light_filtered_temp FROM STDIN WITH CSV HEADER", f)
    ...
    drop_sql = "DROP TABLE IF EXISTS light_filtered_temp;"
    cursor.execute(drop_sql)
...
def load_heavy_filtered_csv_to_postgres():
    # Get PostgreSQL connection
    pg_hook = PostgresHook(postgres_conn_id=POSTGRES_CONN_ID)
    conn = pg_hook.get_conn()
    cursor = conn.cursor()
    ...
    with open(CSV_FILE_PATH_HEAVY_FILTERED, "r") as f:
        cursor.copy_expert("COPY heavy_filtered_temp FROM STDIN WITH CSV HEADER", f)
    ...
    drop_sql = "DROP TABLE IF EXISTS heavy_filtered_temp;"
    cursor.execute(drop_sql)
...
with DAG(
    ...
    load_raw_to_postgres = PythonOperator(
        ...
        python_callable=load_raw_csv_to_postgres,
    )

    load_preprocessed_to_postgres = PythonOperator(
        task_id="load_preprocessed_to_postgres",
        python_callable=load_preprocessed_csv_to_postgres,
    )

    load_light_filtered_to_postgres = PythonOperator(
        task_id="load_light_filtered_to_postgres",
        python_callable=load_light_filtered_csv_to_postgres,
    )

    load_heavy_filtered_to_postgres = PythonOperator(
        task_id="load_heavy_filtered_to_postgres",
    python_callable=load_heavy_filtered_csv_to_postgres,
    )
    ...
    start_task >> load_raw_to_postgres >> load_preprocessed_to_postgres >> load_light_filtered_to_postgres >> load_heavy_filtered_to_postgres >> end_task

...
2. Collect Canada Indeed jobs data from Bright Data and store it in S3.
...
location = 'Canada'
location_index = 1 # 0 for Saudi. 1 for Canada. 2 for USA
csv_file_path_ca_us = '/home/ubuntu/airflow/outputs/concatenated_data_ca.csv' # Output path for the csv data we will load to PostgreSQL

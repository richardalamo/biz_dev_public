...
2. Collect UAE Indeed jobs data from Bright Data and store it in S3.
...
location_index = 3 # 0 for Saudi. 1 for Canada. 2 for USA, 3 for UAE
csv_file_path_ca_us = '/home/ubuntu/airflow/outputs/concatenated_data_ae.csv' # Output path for the csv data we will load to PostgreSQL

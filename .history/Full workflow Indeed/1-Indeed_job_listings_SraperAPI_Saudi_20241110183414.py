...
params = {'premium': 'true', 'render': 'true', 'country_code': 'us','device_type': 'desktop'}
...
if __name__ == "__main__":
    job_titles = ["data analyst","business intelligence", "data engineer","data scientist","machine learning engineer","machine learning","data analyst","business intelligence", "data engineer","data scientist","machine learning engineer","machine learning"]

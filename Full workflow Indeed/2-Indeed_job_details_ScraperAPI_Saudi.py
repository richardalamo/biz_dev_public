...
params = {'ultra_premium': 'true', 'premium': 'true', 'render': 'true', 'country_code': 'us'}
...
if __name__ == "__main__":
    job_titles = ["data scientist", "machine learning engineer", "data analyst", "data engineer", "business intelligence"]

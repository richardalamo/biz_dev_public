...
role = ['data-analyst','data-scientist','data-engineer','machine-learning-engineer']
...
for filename in files:
    try:
        ...
        role_df['Job_ind'] = role_df['Job Role'].map({'MACHINE LEARNING ENGINEER':1,'DATA ENGINEER':2,'DATA SCIENTIST':3,'DATA ANALYST':4})    
